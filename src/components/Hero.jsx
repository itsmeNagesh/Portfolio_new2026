...
//             <div className="h-16">
//               <p className="text-xl sm:text-2xl text-cyan-400 font-medium min-h-[2em]">
//                 {displayText}
...
//                 className="btn-futuristic bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-8 py-6 text-lg rounded-lg border-0"
//               >
...
//                 variant="outline"
//                 className="btn-futuristic border-2 border-cyan-500/50 hover:border-cyan-500 bg-transparent hover:bg-cyan-500/10 text-cyan-400 px-8 py-6 text-lg rounded-lg"
//               >
...
//               {/* Middle ring */}
//               <div className="absolute inset-8 rounded-full border-2 border-cyan-500/30 animate-spin" style={{ animationDuration: '20s' }} />
              
//               {/* Profile photo container */}
//               <div className="absolute inset-12 rounded-full glass neon-glow overflow-hidden border-2 border-cyan-500/50">
//                 <img
...
//                 <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 to-purple-600/10 pointer-events-none" />
//               </div>
...
//                 className="absolute -top-6 right-12 w-16 h-16 glass rounded-lg flex items-center justify-center neon-glow-purple"
//               >
...
//                 className="absolute bottom-8 -left-6 w-16 h-16 glass rounded-lg flex items-center justify-center neon-glow"
//               >
...
//                 className="absolute top-12 -left-6 w-16 h-16 glass rounded-lg flex items-center justify-center neon-glow"
//               >
//                 <Cpu className="w-7 h-7 text-cyan-400" />
//               </motion.div>
              
//               {/* Floating tech icons - Bottom Right */}
//               <motion.div
//                 animate={{ x: [10, -10, 10] }}
//                 transition={{ duration: 4, repeat: Infinity, delay: 1.5 }}
//                 className="absolute bottom-16 -right-6 w-16 h-16 glass rounded-lg flex items-center justify-center neon-glow-purple"
//               >
